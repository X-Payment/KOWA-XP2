/*
               File: WP010_TSMLST
        Description: 取引先支払明細表作成指示
             Author: GeneXus Java Generator version 9_0_3-111
       Generated on: November 20, 2007 15:15:54.29
...
this._SetStandaloneVars=function()
{
   ...
   AV68W_REP_=GXgetControlValue("_W_REP_PG_NM") ;
}
...
_GXValidFnc[41]={lvl:0,grid:0,fnc:null,fld:"_D_DENPYOU_DATE_FROM",gxvar:"AV62D_DENP",op:[],ip:[],nacdep:[],v2v:function(Value){AV62D_DENP=Value},v2c:function(){GXsetControlValue("_D_DENPYOU_DATE_FROM",AV62D_DENP,0)},c2v:function(){AV62D_DENP=GXgetControlValue("_D_DENPYOU_DATE_FROM")}};
_GXValidFnc[42]={lvl:0,grid:0,fnc:null,fld:"_D_DENPYOU_DATE_TO",gxvar:"AV63D_DENP",op:[],ip:[],nacdep:[],v2v:function(Value){AV63D_DENP=Value},v2c:function(){GXsetControlValue("_D_DENPYOU_DATE_TO",AV63D_DENP,0)},c2v:function(){AV63D_DENP=GXgetControlValue("_D_DENPYOU_DATE_TO")}};
_GXValidFnc[46]={lvl:0,grid:0,fnc:null,fld:"_D_SHIHARAI_DATE_FROM",gxvar:"AV64D_SHIH",op:[],ip:[],nacdep:[],v2v:function(Value){AV64D_SHIH=Value},v2c:function(){GXsetControlValue("_D_SHIHARAI_DATE_FROM",AV64D_SHIH,0)},c2v:function(){AV64D_SHIH=GXgetControlValue("_D_SHIHARAI_DATE_FROM")}};
_GXValidFnc[47]={lvl:0,grid:0,fnc:null,fld:"_D_SHIHARAI_DATE_TO",gxvar:"AV65D_SHIH",op:[],ip:[],nacdep:[],v2v:function(Value){AV65D_SHIH=Value},v2c:function(){GXsetControlValue("_D_SHIHARAI_DATE_TO",AV65D_SHIH,0)},c2v:function(){AV65D_SHIH=GXgetControlValue("_D_SHIHARAI_DATE_TO")}};
...
_GXValidFnc[66]={lvl:0,grid:0,fnc:null,fld:"_D_NYURYOKU_DATE_FROM",gxvar:"AV66D_NYUR",op:[],ip:[],nacdep:[],v2v:function(Value){AV66D_NYUR=Value},v2c:function(){GXsetControlValue("_D_NYURYOKU_DATE_FROM",AV66D_NYUR,0)},c2v:function(){AV66D_NYUR=GXgetControlValue("_D_NYURYOKU_DATE_FROM")}};
_GXValidFnc[67]={lvl:0,grid:0,fnc:null,fld:"_D_NYURYOKU_DATE_TO",gxvar:"AV67D_NYUR",op:[],ip:[],nacdep:[],v2v:function(Value){AV67D_NYUR=Value},v2c:function(){GXsetControlValue("_D_NYURYOKU_DATE_TO",AV67D_NYUR,0)},c2v:function(){AV67D_NYUR=GXgetControlValue("_D_NYURYOKU_DATE_TO")}};
this.AV5D_NENDO=0;
this.AV6D_DENPY=0;
this.AV7D_BUMON=0;
this.AV38D_BUMO=0;
